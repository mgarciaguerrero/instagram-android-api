...
public interface MediaService {
    ...
    Call<MediaResponse> getMediaByID(@Path("media-id") String mediaID);

    @GET("v1/media/shortcode/{shortcode}")
    Call<MediaResponse> getMediaShortcode(@Path("shortcode") String shortcode);

    @GET("v1/users/search")
    Call<MediaResponseList> getMediaSearch(@Query("lat") double latitude,
