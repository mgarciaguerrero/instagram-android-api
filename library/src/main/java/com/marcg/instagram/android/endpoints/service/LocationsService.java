...
public interface LocationsService {
    ...
    Call<LocationResponse> getLocationInfo(@Path("location-id") String locationID);

    @GET("v1/locations/{location-id}/media/recent")
    Call<MediaResponse> getLocationMediaList(@Path("location-id") String locationID);

    @GET("v1/locations/search")
    Call<LocationSearchResponse> getLocationSearchedList(@Query("lat") double latitude,
