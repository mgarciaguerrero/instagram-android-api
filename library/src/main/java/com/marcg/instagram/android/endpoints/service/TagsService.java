...
public interface TagsService {
    ...
    Call<TagResponse> getTagInfo(@Path("tag-name") String tagName);

    @GET("v1/tags/{tag-name}/media/recent")
    Call<MediaResponse> getTaggedMediaList(@Path("tag-name") String tagName);

    @GET("v1/tags/search")
    Call<TagSearchResponse> getTagsByName(@Query("q") String tagName);
}
